# Skylake-X/W и Cascade Lake-X/W
...
| SetupVirtualMap | YES | Обратите внимание, что новые версии Asus BIOS(v3006+) не будут загружатся с этим квирком |
...
* **SetupVirtualMap**: YES
  ...
  * Обратите внимание, что новые версии Asus BIOS(v3006+) не будут загружатся с этим квирком
* **SyncRuntimePermissions**: YES
...
На примере этого Skylake-X, мы выберим iMacPro1,1 SMBIOS.
