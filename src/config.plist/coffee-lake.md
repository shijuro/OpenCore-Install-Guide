...
| Поддержка | Версия |
| :--- | :--- |
| Поддерживаемая версия OpenCore | 0.6.4 |
...
Для пользователей с проблемами черного экрана после verbose на B360, B365, H310, H370, Z390, пожалуйста, сомтрите страницу [патчинга BusID iGPU](https://dortania.github.io/OpenCore-Post-Install/gpu-patching/intel-patching/)
...
* **DeduplicateBootOrder**: YES
  * Запрашивает fallback (откат) некоторых переменных с префиксом Boot из `OC_VENDOR_VARIABLE_GUID` в `EFI_GLOBAL_VARIABLE_GUID`. Используется для исправления параметров загрузки.
