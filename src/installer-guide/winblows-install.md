...
* [macrecovery.py](https://github.com/acidanthera/OpenCorePkg/releases)
  * Требует [установленного Python](https://www.python.org/downloads/)
...
Здесь мы будем форматировать наш USB накопитель и добавлять macOS на него, у нас есть два варианта:
